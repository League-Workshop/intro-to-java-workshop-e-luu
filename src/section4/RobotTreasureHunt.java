...
bob.microMove(-10);
	...
	private void spaceBarWasPressed() {
		...
		if(robotXLocation==720 && robotYLocation==420) {JOptionPane.showMessageDialog(null, "Tell the robot where to go next");}
		// 8. Give the user subsequent clues at different locations on the image
		// (pirate robot, swamp, parrots, etc.)
		JOptionPane.showMessageDialog(null, "Clue: the place you seek burns.");
