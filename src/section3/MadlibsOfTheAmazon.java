...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "If you find yourself having to cross a piranha-infested waters here's how to do it...");
		// Get the user to enter an adjective
String adj = JOptionPane.showInputDialog("enter an adjective");
		// Get the user to enter a type of liquid
String happy = JOptionPane.showInputDialog("enter a liquid");
...
JOptionPane.showMessageDialog(null, "Piranhas are more "+ adj +  "during the day, so cross the river at night." +
		 "Piranhas are attracted to fresh "+ "liquid and will most likely take a bite out of your " + part + " if you " 
