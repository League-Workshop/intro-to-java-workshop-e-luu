...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("_maze2.jpg"));
	...
	if(mouseColor==background){
		...
		//if(mouseColor)
	AudioClip win = JApplet.newAudioClip(getClass().getResource("clap.wav"));
				// pop up a message to tell them they won
		if(mouseColor==endColor){win.play();JOptionPane.showMessageDialog(null, "you win!");}
